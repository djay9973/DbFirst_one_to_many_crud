...
using DbFirst_one_to_many_crud.CustomFilter;
...
namespace DbFirst_one_to_many_crud
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("AddCon")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            else
            {
                ...
                app.UseStatusCodePagesWithReExecute("/ErrorLogs/Error/{0}");
            }
            app.UseStaticFiles();
